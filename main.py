...
sys.path.insert(0, '../..')
from trafair_db_config import trafair_db_get_units_of_measure, trafair_db_getConnection
...
def addOptions():
    ...
    parser.add_argument('--df_csv_file_prefix', dest='df_csv_file_prefix', type=str,
                        help='The name of the csv file, set --from_csv True', default='')
